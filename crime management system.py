...
conn = mysql.connector.connect(host='localhost', username='root', password='Newyork@0510', database='management')
...
class Criminal:
    def __init__(self,root):
        ...
        #img_logo = img_logo.resize((60, 60), Image.ANTIALIAS if "antialias" in Image.__dict__ else Image.NEAREST)
